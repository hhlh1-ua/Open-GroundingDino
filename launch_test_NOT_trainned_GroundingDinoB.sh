...
CFG="/workspace/GroundingDINO/Open-GroundingDino/config/cfg_ADL_GRB.py"
...
OUTPUT_DIR="/workspace/GroundingDINO/resultados_test/pre_fine_tunning/GroundingDinoB"
...
python3 -m torch.distributed.launch  --nproc_per_node=${GPU_NUM} main.py \
        ...
        -c ${CFG} \
        --datasets ${DATASETS}  \
        --pretrain_model_path /workspace/GroundingDINO/modelos/groundingdino_swinb_cogcoor.pth \
