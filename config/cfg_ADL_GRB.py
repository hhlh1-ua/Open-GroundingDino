...
batch_size = 4 #Cambiado de 4 a 8 para seguir hiperparámetros de javi
...
hidden_dim = 256
dropout = 0.0 # pasado de 0 a 0.2
nheads = 8
num_queries = 900 #Si quieres cambiar esto, debes de eliminar el parámetro --pretrain_model_path
query_dim = 4
num_patterns = 0
...
dn_bbox_coef = 1.0
embed_init_tgt = True
dn_labelbook_size = 2000 #Cambia esto de 91 a 2000
max_text_len = 256
...
freeze_keywords = ['bert'] #['backbone.0', 'bert']                  # for whole model, e.g. ['backbone.0', 'bert'] for freeze visual encoder and text encoder
...
epochs = 15 # Cambiado a 30 EPOCHS para usar parámetros TFM JAVI
lr_drop = 10
